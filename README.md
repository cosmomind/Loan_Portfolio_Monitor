...
Created key metrics such as total loan applications, funded and received amounts, portfolio at risk, default recovery rate, and month-over-month changes using SQL and DAX. Built a dedicated date table to support accurate time-based analysis.

- **Interactive Dashboard & Visual Analytics**:
Developed a Power BI dashboard with dynamic visuals and filters for state, grade, purpose, and income group. Enabled exploration of loan performance, borrower segments, and trends across different dimensions.
